...
@section('title', 'Campus Buddy | Community')
...
@push('styles')
    ...
    <style>
        ...
        .view-more-districts-btn {
            ...
            box-shadow: 0 4px 15px rgba(200, 164, 90, 0.1);
        }
...
@section('content')
    ...
    <section class="posts">
        ...
        @empty
            <div class="no-posts" style="text-align: center; padding: 60px 20px; background: rgba(255,255,255,0.6); border-radius: 20px; border: 1px dashed #CBD5E0; grid-column: 1 / -1; width: 100%;">
                <div style="font-size: 48px; margin-bottom: 20px;">🏜️</div>
                <h3 style="color: #4A5568; margin-bottom: 10px;">The community is quiet...</h3>
                <p style="color: #718096; margin-bottom: 25px;">Be the first one to start a conversation!</p>
            </div>
        @endforelse
    ...
    <section class="district-section" id="district-section">
        <div class="district-header" style="flex-wrap: wrap; gap: 15px;">
            ...
            <div style="display: flex; gap: 15px; align-items: center;">
                <button id="toggle-map-btn" class="toggle-map-btn" style="background: #00AAFF; color: white; padding: 6px 14px; border-radius: 20px; border: none; font-weight: 600; cursor: pointer; font-size: 12px; display: flex; align-items: center; gap: 6px; transition: all 0.3s ease;">
