            ...
            ->schema([
                Forms\Components\Section::make('Personal Details')
                    ->schema([
                        ...
                        Forms\Components\FileUpload::make('profile_image')->image()->saveUploadedFileUsing(fn ($file) => cloudinary()->upload($file->getRealPath(), ['folder' => 'alumni/profiles'])->getSecurePath())->nullable(),
                    ])->columns([
                        'default' => 2,
                    ]),
                ...
                Forms\Components\Section::make('Academic & Career')
                    ->schema([
                        ...
                        Forms\Components\FileUpload::make('company_logo')->image()->saveUploadedFileUsing(fn ($file) => cloudinary()->upload($file->getRealPath(), ['folder' => 'alumni/logos'])->getSecurePath())->nullable(),
